...
class CanvasDemo:
    ...
    def __init__(self):
        ...
        q42 = self.canvas.create_oval(self.q4x - 5, self.q4y - 5, self.q4x + 55, self.q4y + 55, tags="q42", width='1.5')
        ...
        q62 = self.canvas.create_oval(self.q6x - 5, self.q6y - 5, self.q6x + 55, self.q6y + 55, tags="q62", width='1.5')
        ...
        q82 = self.canvas.create_oval(self.q8x - 5, self.q8y - 5, self.q8x + 55, self.q8y + 55, tags="q82", width='1.5')
